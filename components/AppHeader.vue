  ...
  <div class="">
    ...
    <nav class="navbar">
      <div class="flex-1 py-5">
        ...
        <a class="mt- px-4 normal-case font-bold text-xl">{{ $t("title") }}</a>
      </div>
    ...
    <div v-show="isMenuVisible" class="md:hidden flex justify-center">
      <div class="space-y-3 pt-4">
        <NuxtLink :to="localPath('/')" class="block">{{
          $t("nav_home")
        }}</NuxtLink>
        <NuxtLink :to="localPath('/#about')" class="block">{{
          $t("nav_about")
        }}</NuxtLink>
        <NuxtLink :to="localPath('/work')" class="block">{{
          $t("nav_work")
        }}</NuxtLink>
        <NuxtLink :to="localPath('/contact')" class="block">{{
          $t("nav_contact")
        }}</NuxtLink>
      </div>
    </div>
